...
A deeper look into why the simple linear regression shows such a low R square value in the simple linear regression cases would be interesting. Moreover, looking into other variables that could lower the standard error would help political organization increase engagement with their election ads.
